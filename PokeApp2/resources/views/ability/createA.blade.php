...
<div class="col-lg-6">
    <div class="card">
        <div class="card-header">
            <strong>Añade Una Nueva Habilidad Pokemon</strong>
        </div>
        @if(isset($message))
            {{$message}}
        @endif
        ...
        <div class="card-body card-block">
            <form action="{{ url('createA') }}" method="post" class="form-horizontal">
                @csrf
                @method('POST')
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="nombre" name="nombre" placeholder="Introduce una habilidad pokemon " class="form-control">
