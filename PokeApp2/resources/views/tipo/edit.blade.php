...
<div class="col-lg-6">
    <div class="card">
        <div class="card-header">
            <strong>Edita Un Tipo Pokemon</strong>
        </div>
        @if(isset($message))
            {{$message}}
        @endif
        ...
        <div class="card-body card-block">
            <form action="{{ url('create/' . $tipo->id) }}" method="post" class="form-horizontal">
                @csrf
                @method('PUT')
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="nombre" name="nombre" value="{{ old('nombre', $tipo->nombre)}}" class="form-control">
