        ...
        /*------------------------------------------------------Subir archivo----------------------------------------*/
          ...
          if($request->hasFile($input) && $request->file($input)->isValid()) {
                         ...
                         $nombre = $archivo->getClientOriginalName();
                                ...
                                $data['img']= $this->createId().'.'.$archivo->getClientOriginalExtension();//crear nombre unico para la imagen
                                
                                
                                
                                DB::update('update users set img = :nombreArchivo where id = :id', ['nombreArchivo' => $data['img'],'id' => $user->id]);
